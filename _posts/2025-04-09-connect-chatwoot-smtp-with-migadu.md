...
If you're self-hosting [Chatwoot](https://www.chatwoot.com/) and want to send emails using [Migadu](https://migadu.com/), here’s a quick guide. This helps you send out system emails, like invite emails, password recovery emails, etc. To use it for email conversations, you can set up an inbox in Chatwoot. No need for these environment variables.
